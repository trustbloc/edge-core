...
const (
	...
	getRawDocsFailureErrMsg                    = "failure while getting raw CouchDB documents: %w"
	...
	failureWhileGettingStoredValuesFromRawDocs = "failure while getting stored values from raw docs: %w"
